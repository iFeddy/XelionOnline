...
TRAP_EFFECT_DATA =
{
	...
	TED_TELEPORT_DH = { TED_CHECK_INTERVAL = 0.3, TED_CHECK_DIST = 30,  TED_ABSTATE = "", 	 TED_TEL_LOCATE = { TTL_X = 1000, TTL_Y = 235, }, TED_SKILL_INTERVAL = 0.5, 	TED_SKILL = "E_HwinDHoneying_Skill01_N", },	-- Teleport Trap
	TED_TELEPORT_GH = { TED_CHECK_INTERVAL = 0.3, TED_CHECK_DIST = 30,  TED_ABSTATE = "", 	 TED_TEL_LOCATE = { TTL_X = 1000, TTL_Y = 235, }, TED_SKILL_INTERVAL = 0, 	TED_SKILL = nil, },	-- Teleport Trap
	TED_TELEPORT_KC = { TED_CHECK_INTERVAL = 0.3, TED_CHECK_DIST = 150, TED_ABSTATE = "", 	 TED_TEL_LOCATE = { TTL_X = 1000, TTL_Y = 235, }, TED_SKILL_INTERVAL = 0, 	TED_SKILL = nil, },	-- Teleport Trap
