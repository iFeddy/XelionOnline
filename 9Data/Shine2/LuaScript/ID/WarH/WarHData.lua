...
EVNET_DATA_NO2 =
{
	DEVILDOM =
	{
		...
		REGEN =
		{
			{ MOBCOUNT = 2, POSITION = { X = 6932, Y = 11806, RADIUS = 450 } },
			{ MOBCOUNT = 2, POSITION = { X = 6938, Y = 12379, RADIUS = 450 } },
			{ MOBCOUNT = 2, POSITION = { X = 6939, Y = 12959, RADIUS = 450 } },
	...
	FMCORPS =
	{
		...
		REGEN =
		{
			{ MOBCOUNT = 2, POSITION = { X = 6922, Y = 11806, RADIUS = 200 } },
			{ MOBCOUNT = 2, POSITION = { X = 6928, Y = 12379, RADIUS = 200 } },
			{ MOBCOUNT = 2, POSITION = { X = 6929, Y = 12959, RADIUS = 200 } },
		}
	},
...
EVNET_DATA_NO3 =
{
	...
	HIGH_DEVILDOM =
	{
		...
		REGEN =
		{
			...
			{ MOBCOUNT = 1, POSITION = { X = 11250, Y = 12546, RADIUS = 300 } },
			{ MOBCOUNT = 1, POSITION = { X = 11739, Y = 13172, RADIUS = 400 } },
			{ MOBCOUNT = 1, POSITION = { X = 11394, Y = 13523, RADIUS = 200 } },
			{ MOBCOUNT = 1, POSITION = { X = 11394, Y = 11468, RADIUS = 200 } },
		}
	},
	...
	FMCORPS =
	{
		...
		REGEN =
		{
			{ MOBCOUNT = 2, POSITION = { X = 11730, Y = 11897, RADIUS = 200 } },
			{ MOBCOUNT = 2, POSITION = { X = 11240, Y = 12546, RADIUS = 200 } },
			{ MOBCOUNT = 2, POSITION = { X = 11729, Y = 13172, RADIUS = 200 } },
		}
	},
...
EVNET_DATA_NO4 =
{
	DEVILDOM =
	{
		...
		REGEN =
		{
			{ MOBCOUNT = 3, POSITION = { X = 15985, Y = 11947, RADIUS = 300 } },
			{ MOBCOUNT = 4, POSITION = { X = 15834, Y = 12563, RADIUS = 400 } },
			{ MOBCOUNT = 3, POSITION = { X = 16037, Y = 13052, RADIUS = 450 } },
			{ MOBCOUNT = 3, POSITION = { X = 16397, Y = 11334, RADIUS = 300 } },
			{ MOBCOUNT = 4, POSITION = { X = 16397, Y = 13653, RADIUS = 400 } },
		}
	},
	...
	HIGH_DEVILDOM =
	{
		...
		REGEN =
		{
			...
			{ MOBCOUNT = 2, POSITION = { X = 16037, Y = 13052, RADIUS = 450 } },
	...
	FMCORPS =
	{
		...
		REGEN =
		{
			{ MOBCOUNT = 2, POSITION = { X = 15975, Y = 11947, RADIUS = 400 } },
			{ MOBCOUNT = 2, POSITION = { X = 15824, Y = 12563, RADIUS = 400 } },
			{ MOBCOUNT = 2, POSITION = { X = 16027, Y = 13052, RADIUS = 400 } },
		}
	},
