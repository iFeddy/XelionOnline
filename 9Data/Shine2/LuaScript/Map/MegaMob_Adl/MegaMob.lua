...
require( "Map/MegaMob_Adl/MegaMob_Data" )			--External Script Data
----------------------------------------------------------------------------------------------
-- To do list:																				--
...
FileInfo = {}
FileInfo.FileName		= 'MegaMob_Adl'	--File Name
FileInfo.MapName		= 'Adl'			--Map Name (InxName)
...
cExecCheck( 'Mega_SpawnControl' )
	...
	if Var.MegaMobAlive == false and Var.MobTimer <= cCurSec() then
		...
		Var.IndexLocRnd = math.random(1, 4)	--Eventually use math.random(10) = 1~10 (For MaxLetterType / 1 for each SpawnLoc)
