...
require( "Map/MegaMob_UrgSwaDn01/MegaMob_Data" )			--External Script Data
----------------------------------------------------------------------------------------------
-- To do list:																				--
...
FileInfo = {}
FileInfo.FileName		= 'MegaMob_UrgSwaDn01'			--File Name
FileInfo.MapName		= 'UrgSwaDn01'					--Map Name (InxName)
