...
require( "Map/Dice/Data/Name" ) 					-- 파일경로, 파일이름, 역참조를 위한 네임 테이블
require( "Map/Dice/Data/Process" )		   		 	-- 각종 딜레이타임과 링크 정보, 공지, 퀘스트 등의 진행 관련 데이터
require( "Map/Dice/Data/Regen" )					-- 리젠 데이터(그룹, 몹, NPC, 문, 아이템 등의 리젠 종류, 위치 및 속성 관련)

require( "Map/Dice/Functions/SubFunc" )			-- 전체적인 진행에 필요한 각종 Sub Functions
require( "Map/Dice/Functions/Routine" )			-- 몹 등에 붙는 AI 관련 루틴들
require( "Map/Dice/Functions/Progress" )			-- 각 단계가 정의된 진행 함수들
--]]--
